...
.header {
	...
	.header .wrapper {height:29px;position:relative;border:none;}
	.wrapper .nav {
	list-style:none;
	font-size:13px;
	position:absolute;
	...
	/*.wrapper .nav li.rightnav { float:left; margin:0 0 0 0; font-size:11px; }
...
#blog .bodycontent{width: 960px;}
#blog #maincontent{width: 100%;}
#blog .wrapper table#posts{width: 100%; font-size: 16px;}
#blog .wrapper table td {line-height: 36px !important;}
